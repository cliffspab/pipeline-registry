...
1. **REFERENCES.gdoc** House exceptions, transliterations, naming traps and geopolitical rulings.  
     
2. **STATUS.gdoc** Canonical register of rank, title, office and life-status changes. Scan before any high-profile status edit; ranks alongside REFERENCES.  
     
3. **PROCESSES.gdoc** House conventions — numbers, times, dates, currency, honorifics and PR handling. These rules apply universally to all copy.  
...
* **Status or office-holder claims:** Any name carrying a title, office or life-status claim — scan `STATUS.gdoc`, the canonical register.
