...
REM compile.yml derives GUIDE/PROCESSES/DIRECTORY/docx/manifest and commits them to main on
...
if errorlevel 1 (
  ...
  echo         Derived files ^(Blueprint\GUIDE.txt, PROCESSES.txt, DIRECTORY.*^) are regenerated
